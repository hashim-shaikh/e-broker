...
class AppSettings {
  ///Basic Settings
  static const String applicationName = 'Rentiee';
  static const String androidPackageName = 'com.ebroker.wrteam';

  ///API Setting
  // static const String hostUrl = 'https://upgoal.digiatto.xyz';
  static const String hostUrl = 'https://admin.rentiee.com';
...
it will call API in background without showing the process and when data available it will replace it with new data */
  ...
  static const String deepLinkName = 'Techpanda.asia'; //deeplink demo.com
