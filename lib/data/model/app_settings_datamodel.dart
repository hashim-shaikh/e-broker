...
class AppSettingsDataModel {
  ...
  static String _colorToHex(Color color) {
    final red = (color.red * 255).toInt().toRadixString(16).substring(2);
    final green = (color.green * 255).toInt().toRadixString(16).substring(2);
    final blue = (color.blue * 255).toInt().toRadixString(16).substring(2);
