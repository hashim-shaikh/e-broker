...
const Color tertiaryColor_ = Color(0xFF34495e);
const Color textColor = Color(0xFF4D5454);
Color lightTextColor = const Color(0xFF4D5454);




Color widgetsBorderColorLight = const Color(0xffEEEEEE);
...
Color lightTextColorDarkTheme = const Color(0xffFDFDFD);
...
extension ColorPrefs on ColorScheme {
  ...
  Color get primaryColor => _getColor(
    brightness,
    lightColor: appSettings.lightPrimary ?? primaryColor_,
    darkColor: appSettings.darkPrimary ?? primaryColorDark,
  );
